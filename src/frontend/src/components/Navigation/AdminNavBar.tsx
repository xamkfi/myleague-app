...
function AdminNavBar({ collapsed, onToggleCollapse }: AdminNavBarProps) {
    ...
    const userInitial = (user?.person?.fullName ??
        user?.email ??
        "?")[0].toUpperCase();
        ...
        >
            <div className="admin-navbar-header">
                <div className="admin-navbar-header-row">
                    ...
                    >
                        <span
                            className={`admin-navbar-toggle-icon ${collapsed ? "admin-navbar-toggle-icon--collapsed" : ""}`}
                        >
                            ‹
                        </span>
                    </button>
            ...
            <div className="admin-navbar-content">
                <div className="admin-navbar-section">
                    {!collapsed && (
                        <h3 className="admin-navbar-section-title">
                            {t("admin.database", "Database")}
                        </h3>
                    )}
                    <ul className="admin-navbar-menu">
                        <li
                            className={`admin-navbar-item ${isActive("/admin") ? "active" : ""}`}
                        >
                            <Link
                                to="/admin"
                                title={
                                    collapsed
                                        ? t("admin.actions.home", "Home")
                                        : undefined
                                }
                            >
                                <img
                        ...
                        <li
                            className={`admin-navbar-item ${isActive("/admin/persons") ? "active" : ""}`}
                        >
                            <Link
                                to="/admin/persons"
                                title={
                                    collapsed
                                        ? t("admin.actions.persons", "Persons")
                                        : undefined
                                }
                            >
                                <img
                        ...
                        <li
                            className={`admin-navbar-item ${isActive("/admin/news") ? "active" : ""}`}
                        >
                            <Link
                                to="/admin/news"
                                title={
                                    collapsed
                                        ? t("admin.actions.news", "News")
                                        : undefined
                                }
                            >
                                <img
                        ...
                        <li
                            className={`admin-navbar-item ${isActive("/admin/rules") ? "active" : ""}`}
                        >
                            <Link
                                to="/admin/rules"
                                title={collapsed ? "Säännöt" : undefined}
                            >
                                <img
                                    src={RulesIcon}
                                    alt="Rules"
                                    className="icon"
                                />
                                {!collapsed && <span>{t("Rules")}</span>}
                            </Link>
                        </li>
                        <li
                            className={`admin-navbar-item ${isActive("/admin/divisions") ? "active" : ""}`}
                        >
                            <Link
                                to="/admin/divisions"
                                title={
                        ...
                        <li
                            className={`admin-navbar-item ${isActive("/admin/clubs") ? "active" : ""}`}
                        >
                            <Link
                                to="/admin/clubs"
                                title={
                                    collapsed
                                        ? t("admin.actions.clubs", "Clubs")
                                        : undefined
                                }
                            >
                                <img
                        ...
                        <li
                            className={`admin-navbar-item ${isActive("/admin/users") ? "active" : ""}`}
                        >
                            <Link
                                to="/admin/users"
                                title={
                ...
                <div className="admin-navbar-section">
                    {!collapsed && (
                        <h3 className="admin-navbar-section-title">
                            {t("admin.sportsTitle", "Sports")}
                        </h3>
                    )}
                    <ul className="admin-navbar-menu">
                        <li
                            className={`admin-navbar-item ${isFloorballActive() ? "active" : ""}`}
                        >
                            {collapsed ? (
                                <Link
                                    to="/admin/floorball"
                                    title={t(
                                        "admin.actions.floorball",
                                        "Floorball",
                                    )}
                                >
                                    <img
                            ...
                            {!collapsed && floorballDropdownOpen && (
                                <ul className="admin-navbar-submenu">
                                    <li
                                        className={`admin-navbar-submenu-item ${isActive("/admin/floorball/teams") ? "active" : ""}`}
                                    >
                                        <Link to="/admin/floorball/teams">
                                            ...
                                            <span>
                                                {t(
                                                    "floorball.management.actions.teams",
                                                    "Teams",
                                                )}
                                            </span>
                                        </Link>
                                    ...
                                    <li
                                        className={`admin-navbar-submenu-item ${isActive("/admin/floorball/players") ? "active" : ""}`}
                                    >
                                        <Link to="/admin/floorball/players">
                                            ...
                                            <span>
                                                {t(
                                                    "floorball.management.actions.players",
                                                    "Players",
                                                )}
                                            </span>
                                        </Link>
                                    ...
                                    <li
                                        className={`admin-navbar-submenu-item ${isActive("/admin/floorball/seasons") ? "active" : ""}`}
                                    >
                                        <Link to="/admin/floorball/seasons">
                                            ...
                                            <span>
                                                {t(
                                                    "floorball.management.actions.seasons",
                                                    "Seasons",
                                                )}
                                            </span>
                                        </Link>
                                    ...
                                    <li
                                        className={`admin-navbar-submenu-item ${isActive("/admin/floorball/matches") ? "active" : ""}`}
                                    >
                                        <Link to="/admin/floorball/matches">
                                            ...
                                            <span>
                                                {t(
                                                    "floorball.management.actions.matches",
                                                    "Matches",
                                                )}
                                            </span>
                                        </Link>
                                    ...
                                    <li
                                        className={`admin-navbar-submenu-item ${isActive("/admin/floorball/referees") ? "active" : ""}`}
                                    >
                                        <Link to="/admin/floorball/referees">
                                            ...
                                            <span>
                                                {t(
                                                    "floorball.management.actions.referees",
                                                    "Referees",
                                                )}
                                            </span>
                                        </Link>
            ...
            <div className="admin-navbar-footer">
                {collapsed ? (
                    ...
                    >
                        <div className="admin-navbar-user-info">
                            ...
                            <span className="admin-navbar-user-role">
                                {user?.email ?? ""}
                            </span>
                        </div>
                        <span className="admin-navbar-user-dropdown-icon">
                            ▼
                        </span>
                    </div>
                )}
                {userDropdownOpen && (
                    <div className="admin-navbar-user-menu">
                        <button
                            className="admin-navbar-user-menu-item"
