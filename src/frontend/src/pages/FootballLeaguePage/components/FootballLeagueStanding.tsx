import './FootballLeagueStanding.scss';
import type {
...
export default function FootballLeagueStanding({ seasonSummary, loading, error, standingsOverride, titleOverride }: LeagueStandingProps) {
  ...
  const renderStandingsTable = () => {
    const data: FootballTeamSeasonStatisticsDto[] = seasonSummary?.teamStandings || [];
              ...
              >
                ...
                <td className="form-col">
                  <div className="form-indicators">
                    {form.map((result: FootballGameResult, formIndex: number) => {    
                      return (
                        <div 
                          key={formIndex} 
  ...
  const renderTopScorersTable = () => {
    ...
    return (
      <table className="standing-table">
        ...
        <tbody>
          {scorers.map((player: FootballPlayerSeasonStatisticsDto, index: number) => {
            const rank = index + 1;
  ...
  const renderTopAssistsTable = () => {
    ...
    return (
      <table className="standing-table">
        ...
        <tbody>
          {assists.map((player: FootballPlayerSeasonStatisticsDto, index: number) => {
            const rank = index + 1;
