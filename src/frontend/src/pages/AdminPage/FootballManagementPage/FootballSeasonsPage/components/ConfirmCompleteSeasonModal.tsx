      ...
      >
        <div className="confirm-complete-modal__header">
          ...
          <div>
            <h2 id="confirm-complete-season-title">
              {t(
                'football.seasons.completeConfirm.title',
                'Päätä Kausi?'
              )}
            </h2>
            ...
            <p>
              {t(
                'football.seasons.completeConfirm.subtitle',
        ...
        <div className="confirm-complete-modal__body">
          ...
          <div className="confirm-complete-modal__details">
            <div>
              <span>{t('football.seasons.fields.division', 'Division')}</span>
              <strong>
                {t(
                  'football.seasons.completeConfirm.divisionCount',
                  '{{count}} division(s)',
                  { count: divisionCount }
                )}
              </strong>
            ...
            <div>
              <span>{t('football.seasons.fields.teams', 'Teams')}</span>
              <strong>
                {t(
                  'football.seasons.completeConfirm.teamCount',
                  '{{count}} team(s)',
                  { count: teamCount }
                )}
              </strong>
          ...
          <div className="confirm-complete-modal__warning">
            ...
            <p>
              {t(
                'football.seasons.completeConfirm.warning',
          ...
          >
            {loading ? (
              ...
              <>
                ...
                {t(
                  'football.seasons.completeConfirm.confirmButton',
                  'Päätä Kausi'
                )}
              </>
            )}
