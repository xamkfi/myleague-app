    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="confirm-modal-content" onClick={e => e.stopPropagation()}>
        <div className="confirm-modal-header">
          <h2>
            {t(`football.players.bulkStatusUpdate.${actionText}Title`, 
        ...
        <div className="confirm-modal-body">
          ...
          <div className="confirm-message">
            <p>
              {t(`football.players.bulkStatusUpdate.${actionText}Message`, 
            ...
            {selectedCount > targetCount && (
              <div className="status-breakdown">
                <p className="info-text">
                  {t('football.players.bulkStatusUpdate.breakdown', 
                ...
                <p className="action-text">
                  {t(`football.players.bulkStatusUpdate.${actionText}Only`, 
        ...
        <div className="confirm-modal-footer">
          ...
          >
            {isUpdating 
              ? t(`football.players.bulkStatusUpdate.${actionText}ing`, `${action === 'activate' ? 'Activating' : 'Deactivating'}...`)
              : t(`football.players.bulkStatusUpdate.${actionText}Confirm`, `${action === 'activate' ? 'Activate' : 'Deactivate'} (${targetCount})`)}
          </button>
        </div>
      </div>
    </div>
