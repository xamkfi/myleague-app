...
/**
 * Sorts players for the goal/card/substitution selectors. Players are ordered by jersey number
 ...
 */
export const sortPlayersForSelect = (players: readonly FootballPlayerDto[]): FootballPlayerDto[] => {
 ...
 */
export const formatPlayerOptionLabel = (player: FootballPlayerDto): string => {
