...
namespace MyLeague.Infrastructure.Persistence.Migrations.FloorBallDb
{
    ...
    [Migration("20260309090207_AddFloorballTournamentSupport")]
    partial class AddFloorballTournamentSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.FloorballMatch", b =>
                {
                    ...
                    b.Property<string>("TournamentRound")
                        .HasMaxLength(50)
                    ...
                    b.ToTable("FloorballMatches", "floorball", t =>
                        {
                            t.HasCheckConstraint("CK_FloorballMatches_SeasonOrTournament", "\"SeasonId\" IS NOT NULL OR \"TournamentId\" IS NOT NULL");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Tournament.FloorballTournament", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("GroupStageAdvancingCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
                    ...
                    b.ToTable("FloorballTournaments", "floorball");
                });

            modelBuilder.Entity("Domain.Entities.Floorball.Tournament.FloorballTournamentGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TournamentId", "Name", "Phase")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Tournament.FloorballTournamentGroupTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.FloorballMatch", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Floorball.Tournament.FloorballTournamentGroup", "TournamentGroup")
                        .WithMany()
                        .HasForeignKey("TournamentGroupId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Domain.Entities.Floorball.Tournament.FloorballTournament", "Tournament")
                        .WithMany("Matches")
                    ...
                    b.OwnsOne("Domain.ValueObjects.Floorball.FloorballMatchRules", "MatchRules", b1 =>
                        {
                            ...
                            b1.ToTable("FloorballSeasons", "floorball");
                    ...
                    b.OwnsOne("Domain.ValueObjects.Floorball.FloorballMatchRules", "MatchRules", b1 =>
                        {
                            ...
                            b1.ToTable("FloorballTournaments", "floorball");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Tournament.FloorballTournamentGroupTeam", b =>
                {
                    b.HasOne("Domain.Entities.Floorball.Tournament.FloorballTournamentGroup", "Group")
                        .WithMany("Teams")
