...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballCompetition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballCompetitionDivision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballCompetitionDivisionTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Statistics.FloorballGoalieSeasonStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.FloorballMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.FloorballMatchActivePlayer", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_FloorballMatchActivePlayer_CreatedAt");

                    b.HasIndex("PlayerId");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_FloorballMatchActivePlayer_UpdatedAt")
                        .HasFilter("\"UpdatedAt\" IS NOT NULL");

                    b.HasIndex("CreatedAt", "UpdatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_FloorballMatchActivePlayer_Audit");
                    ...
                    b.ToTable("FloorballMatchActivePlayers", "floorball");
                });

            modelBuilder.Entity("Domain.Entities.Floorball.Matches.Events.FloorballMatchEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Statistics.FloorballMatchTeamStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.FloorballPeriodScore", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("Unique identifier for the entity");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Teams.FloorballPlayer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Statistics.FloorballPlayerSeasonStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Officials.FloorballReferee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballSeasonContentBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FloorballSeasonContentBlocks", "floorball");
                });

            modelBuilder.Entity("Domain.Entities.Floorball.Statistics.FloorballStatisticsCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Teams.FloorballTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Teams.FloorballTeamManager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Teams.FloorballTeamPlayer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasComment("Unique identifier for the entity");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Statistics.FloorballTeamSeasonStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballTournamentGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballTournamentGroupTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballSeason", b =>
                {
                    b.HasBaseType("Domain.Entities.Floorball.Competitions.FloorballCompetition");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.Events.FloorballGoal", b =>
                {
                    b.HasBaseType("Domain.Entities.Floorball.Matches.Events.FloorballMatchEvent");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.Events.FloorballPenalty", b =>
                {
                    b.HasBaseType("Domain.Entities.Floorball.Matches.Events.FloorballMatchEvent");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.Events.FloorballSave", b =>
                {
                    b.HasBaseType("Domain.Entities.Floorball.Matches.Events.FloorballMatchEvent");
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballCompetitionDivision", b =>
                {
                    b.HasOne("Domain.Entities.Floorball.Competitions.FloorballCompetition", "Competition")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballCompetitionDivisionTeam", b =>
                {
                    b.HasOne("Domain.Entities.Floorball.Competitions.FloorballCompetitionDivision", "CompetitionDivision")
                        .WithMany("Teams")
                        .HasForeignKey("CompetitionDivisionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Floorball.Teams.FloorballTeam", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Statistics.FloorballGoalieSeasonStatistics", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Floorball.Teams.FloorballPlayer", "Player")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.FloorballMatch", b =>
                {
                    b.HasOne("Domain.Entities.Floorball.Teams.FloorballTeam", "AwayTeam")
                        .WithMany()
                    ...
                    b.HasOne("Domain.Entities.Floorball.Teams.FloorballTeam", "HomeTeam")
                        .WithMany()
                        .HasForeignKey("HomeTeamId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.Floorball.Matches.FloorballMatch", null)
                        .WithMany()
                        .HasForeignKey("NextMatchId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.Floorball.Competitions.FloorballTournamentGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.FloorballMatchActivePlayer", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Floorball.Teams.FloorballPlayer", null)
                        .WithMany()
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Matches.Events.FloorballMatchEvent", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Floorball.Teams.FloorballTeam", null)
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballSeasonContentBlock", b =>
                {
                    b.HasOne("Domain.Entities.Floorball.Competitions.FloorballSeason", null)
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballTournamentGroup", b =>
                {
                    b.HasOne("Domain.Entities.Floorball.Competitions.FloorballTournament", null)
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("Domain.Entities.Floorball.Competitions.FloorballTournamentGroupTeam", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Floorball.Competitions.FloorballTournamentGroup", "TournamentGroup")
                        .WithMany("Teams")
                        .HasForeignKey("TournamentGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FloorballCompetitionTeam", b =>
                {
                    b.HasOne("Domain.Entities.Floorball.Competitions.FloorballCompetition", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FloorballMatchOfficial", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Floorball.Officials.FloorballReferee", null)
                        .WithMany()
