...
namespace MyLeague.Infrastructure.DomainEvents.Handlers.Floorball
{
    ...
    /// </summary>
    public class FloorballSeasonCompletedEventHandler : NotificationDomainEventHandler<FloorballSeasonCompletedEvent>
    {
        ...
        protected override async Task<(string EventName, object? Notification)> BuildNotificationAsync(
            FloorballSeasonCompletedEvent domainEvent,
            CancellationToken cancellationToken = default)
        {
            ...
            if (season == null)
            {
                ...
                return (FloorballNotificationEvents.SeasonCompleted, null);
            }

            FloorballSeasonCompletedNotification notification = new()
            {
                SeasonId = season.Id,
            ...
            return (FloorballNotificationEvents.SeasonCompleted, notification);
        }
    }
} 