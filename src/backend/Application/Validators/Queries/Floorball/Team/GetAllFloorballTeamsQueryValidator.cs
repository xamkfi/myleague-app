...
public class GetAllFloorballTeamsQueryValidator : AbstractValidator<GetAllFloorballTeamsQuery>
{
    ...
    public GetAllFloorballTeamsQueryValidator(IPaginationService paginationService)
    {
    ...
    {
        return _paginationService.IsValidPageSize(GetAllFloorballTeamsQuery.ResourceKey, pageSize);
    }

    private string GetPageSizeErrorMessage()
    {
        PaginationSettings settings = _paginationService.GetPaginationSettings(GetAllFloorballTeamsQuery.ResourceKey);
