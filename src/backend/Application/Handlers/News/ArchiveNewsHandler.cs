...
/// </summary>
public class ArchiveNewsHandler : IRequestHandler<ArchiveNewsCommand, Result<bool>>
{
    private readonly INewsRepository _newsRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<ArchiveNewsHandler> _logger;
    ...
    public ArchiveNewsHandler(INewsRepository newsRepository, IUnitOfWork unitOfWork, ILogger<ArchiveNewsHandler> logger)
    {
    ...
    public async Task<Result<bool>> Handle(ArchiveNewsCommand request, CancellationToken cancellationToken)
    {
        try
        {
