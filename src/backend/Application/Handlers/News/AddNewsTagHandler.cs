...
/// </summary>
public class AddNewsTagHandler : IRequestHandler<AddNewsTagCommand, Result<bool>>
{
    private readonly INewsRepository _newsRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<AddNewsTagHandler> _logger;
    ...
    public AddNewsTagHandler(INewsRepository newsRepository, IUnitOfWork unitOfWork, ILogger<AddNewsTagHandler> logger)
    {
    ...
    public async Task<Result<bool>> Handle(AddNewsTagCommand request, CancellationToken cancellationToken)
    {
        try
        {
