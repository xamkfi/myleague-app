...
/// </summary>
public class RemoveNewsTagHandler : IRequestHandler<RemoveNewsTagCommand, Result<bool>>
{
    private readonly INewsRepository _newsRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<RemoveNewsTagHandler> _logger;
    ...
    public RemoveNewsTagHandler(INewsRepository newsRepository, IUnitOfWork unitOfWork, ILogger<RemoveNewsTagHandler> logger)
    {
    ...
    public async Task<Result<bool>> Handle(RemoveNewsTagCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            News? existingNews = await _newsRepository.GetByIdAsync(request.NewsId, cancellationToken);
