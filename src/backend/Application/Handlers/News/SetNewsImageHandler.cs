...
/// </summary>
public class SetNewsImageHandler : IRequestHandler<SetNewsImageCommand, Result<bool>>
{
    private readonly INewsRepository _newsRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<SetNewsImageHandler> _logger;
    ...
    public SetNewsImageHandler(INewsRepository newsRepository, IUnitOfWork unitOfWork, ILogger<SetNewsImageHandler> logger)
    {
    ...
    public async Task<Result<bool>> Handle(SetNewsImageCommand request, CancellationToken cancellationToken)
    {
        try
        {
