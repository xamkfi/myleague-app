...
public class AddTeamToSeasonDivisionHandler : IRequestHandler<AddFootballTeamToSeasonDivisionCommand, Result>
{
    ...
    public async Task<Result> Handle(AddFootballTeamToSeasonDivisionCommand request, CancellationToken cancellationToken)
    {
        try
        {
