...
public class RemoveDivisionFromSeasonHandler : IRequestHandler<RemoveFootballDivisionFromSeasonCommand, Result>
{
    ...
    public async Task<Result> Handle(RemoveFootballDivisionFromSeasonCommand request, CancellationToken cancellationToken)
    {
        try
        {
