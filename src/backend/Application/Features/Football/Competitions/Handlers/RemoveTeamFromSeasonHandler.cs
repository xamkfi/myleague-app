...
public class RemoveTeamFromSeasonHandler : IRequestHandler<RemoveFootballTeamFromSeasonCommand, Result<FootballSeasonDto>>
{
    ...
    public async Task<Result<FootballSeasonDto>> Handle(RemoveFootballTeamFromSeasonCommand request, CancellationToken cancellationToken)
    {
        try
        {
