...
/// <summary>
/// Validator for DeleteFootballTeamManagerCommand
/// </summary>
public class DeleteFootballTeamManagerCommandValidator : AbstractValidator<DeleteFootballTeamManagerCommand>
{
    public DeleteFootballTeamManagerCommandValidator()
    {
        RuleFor(x => x.Id)
