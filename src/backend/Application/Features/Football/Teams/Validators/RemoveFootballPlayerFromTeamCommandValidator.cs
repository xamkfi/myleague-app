...
/// <summary>
/// Validator for RemoveFootballPlayerFromTeamCommand
/// </summary>
public class RemovePlayerFromTeamCommandValidator : AbstractValidator<RemoveFootballPlayerFromTeamCommand>
{
