...
/// <summary>
/// Validator for UpdateFootballTeamPlayerStatsCommand
/// </summary>
public class UpdateTeamPlayerStatsCommandValidator : AbstractValidator<UpdateFootballTeamPlayerStatsCommand>
{
