...
/// <summary>
/// Validator for UpdateFootballTeamPlayerJerseyNumberCommand
/// </summary>
public class UpdateTeamPlayerJerseyNumberCommandValidator : AbstractValidator<UpdateFootballTeamPlayerJerseyNumberCommand>
{
