...
namespace Application.Features.Football.Teams.Mappings;

/// <summary>
/// Mapper for FootballTeam entity
/// </summary>
public static class FootballTeamMapper
{
    /// <summary>
    /// Maps a FootballTeam entity to a FootballTeamDto
    /// </summary>
    ...
    public static FootballTeamDto ToDto(FootballTeam team, Club? club, Dictionary<Guid, Person>? playerPersons)
    {
        if (team == null)
        ...
        return new FootballTeamDto(
            ...
            team.Roster.Select(p => 
            {
                ...
                return new FootballTeamPlayerDto(
                    team.Id,
                    p.PlayerId,
                    playerName,
                    p.Position,
    ...
    public static FootballTeamDto ToDto(FootballTeam team, Club club)
        => ToDto(team, club, new Dictionary<Guid, Person>());

    /// <summary>
    /// Maps a collection of FootballTeam entities to FootballTeamDtos
    /// </summary>
    ...
    public static IEnumerable<FootballTeamDto> ToDtos(IEnumerable<FootballTeam> teams, Dictionary<Guid, Club>? clubs = null, Dictionary<Guid, Person>? playerPersons = null)
    {
        if (teams == null)
    ...
    /// <summary>
    /// Creates a new FootballTeam entity from a create command
    /// </summary>
    ...
    public static FootballTeam ToEntity(CreateFootballTeamCommand command, Club club)
    {
        if (command == null)
        ...
        // throw new NotImplementedException("This method requires a Club entity to be provided. The FootballTeam constructor needs a Club entity, but the command only contains ClubId.");
    ...
    /// <summary>
    /// Updates a FootballTeam entity from an update command
    /// </summary>
    ...
    public static void UpdateFromCommand(FootballTeam team, UpdateFootballTeamCommand command)
    {
        if (team == null)
            throw new ArgumentNullException(nameof(team));
        if (command == null)
    ...
    /// <summary>
    /// Maps a FootballTeam entity to a FootballTeamSummaryDto (without roster)
    /// </summary>
    /// <param name="team">The team entity to map</param>
    /// <param name="club">The club entity (optional, since Club navigation is ignored in EF)</param>
    /// <returns>The mapped summary DTO</returns>
    /// <exception cref="ArgumentNullException">Thrown when team is null</exception>
    public static FootballTeamSummaryDto ToSummaryDto(FootballTeam team, Club? club)
    {
        if (team == null)
            throw new ArgumentNullException(nameof(team));
    ...
    /// <summary>
    /// Maps a collection of FootballTeam entities to FootballTeamSummaryDtos (without roster)
    /// </summary>
    /// <param name="teams">The team entities to map</param>
    /// <param name="clubs">Dictionary of clubs keyed by club ID</param>
    /// <returns>The mapped summary DTOs</returns>
    /// <exception cref="ArgumentNullException">Thrown when teams is null</exception>
    public static IEnumerable<FootballTeamSummaryDto> ToSummaryDtos(IEnumerable<FootballTeam> teams, Dictionary<Guid, Club>? clubs = null)
    {
        if (teams == null)
            throw new ArgumentNullException(nameof(teams));
