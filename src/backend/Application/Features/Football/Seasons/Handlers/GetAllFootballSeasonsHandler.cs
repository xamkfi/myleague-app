...
public class GetAllFootballSeasonsHandler : IRequestHandler<GetAllFootballSeasonsQuery, Result<IEnumerable<FootballSeasonDto>>>
{
    ...
    private readonly ILogger<GetAllFootballSeasonsHandler> _logger;

    public GetAllFootballSeasonsHandler(
        IFootballCompetitionRepository seasonRepository,
        IFootballCompetitionDivisionRepository seasonDivisionRepository,
        IClubRepository clubRepository,
        ILogger<GetAllFootballSeasonsHandler> logger)
    {
    ...
    public async Task<Result<IEnumerable<FootballSeasonDto>>> Handle(
        GetAllFootballSeasonsQuery request,
        CancellationToken cancellationToken)
    {
        try
        {
            _logger.LogInformation("Retrieving all football seasons");
        ...
        {
            _logger.LogError(ex, "Error occurred while retrieving all football seasons");
