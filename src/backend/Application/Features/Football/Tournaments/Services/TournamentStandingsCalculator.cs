...
public static class TournamentStandingsCalculator
{
    ...
    /// <c>FootballTournamentGroupStandingDto</c>; the calculator stays in the application layer
    ...
    /// </summary>
    public static List<StandingsRow> Compute(FootballTournamentGroup group, IEnumerable<FootballMatch> completedMatches)
    {
        ...
        foreach (FootballMatch match in completedMatches)
        {
