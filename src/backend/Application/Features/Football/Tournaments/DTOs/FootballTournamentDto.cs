...
/// </summary>
public record FootballPlayoffScheduleSlotDto(
...
/// <summary>
/// Data Transfer Object for FootballTournament entity
/// </summary>
...
public record FootballTournamentDto(
    Guid Id,
    string Name,
    DateTime StartDate,
    DateTime EndDate,
    ...
    FootballTournamentRulesDto TournamentRules,
    List<FootballTournamentGroupDto> Groups,
    int TeamCount,
    int MatchCount,
