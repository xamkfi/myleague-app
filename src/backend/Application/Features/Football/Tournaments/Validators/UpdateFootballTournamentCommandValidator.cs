...
/// <summary>
/// Validator for UpdateFootballTournamentCommand
/// </summary>
public class UpdateFootballTournamentCommandValidator : AbstractValidator<UpdateFootballTournamentCommand>
{
    public UpdateFootballTournamentCommandValidator()
    {
