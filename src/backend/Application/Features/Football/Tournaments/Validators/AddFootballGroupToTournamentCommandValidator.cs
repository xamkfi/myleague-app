...
/// <summary>
/// Validator for AddFootballGroupToTournamentCommand
/// </summary>
public class AddGroupToTournamentCommandValidator : AbstractValidator<AddFootballGroupToTournamentCommand>
{
