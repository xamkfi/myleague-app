...
/// <summary>
/// Handles UpdateHockeySeason.
/// </summary>
public class UpdateHockeySeasonHandler : IRequestHandler<UpdateHockeySeasonCommand, Result<HockeySeasonDto>>
{
    private readonly IHockeyCompetitionRepository _competitionRepository;
    private readonly IHockeyUnitOfWork _unitOfWork;
    private readonly ILogger<UpdateHockeySeasonHandler> _logger;

    public UpdateHockeySeasonHandler(
        IHockeyCompetitionRepository competitionRepository,
        IHockeyUnitOfWork unitOfWork,
        ILogger<UpdateHockeySeasonHandler> logger)
    {
    ...
    public async Task<Result<HockeySeasonDto>> Handle(
        UpdateHockeySeasonCommand request,
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogWarning(ex, "Domain rejected UpdateHockeySeason for season {SeasonId}", request.SeasonId);
