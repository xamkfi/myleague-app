...
namespace Application.Features.Common.Organization.Deletion;
...
public sealed class PersonDeletionGuard : IPersonDeletionGuard
{
    ...
    public async Task<PersonDeletionEvaluation> EvaluateAsync(Guid personId, CancellationToken cancellationToken)
    {
        ...
        Domain.Entities.Floorball.Teams.FloorballPlayer? floorballPlayer =
        ...
        Domain.Entities.Floorball.Officials.FloorballReferee? floorballReferee =
        ...
        Domain.Entities.Football.Officials.FootballReferee? footballReferee =
        ...
        Domain.Entities.Hockey.Officials.HockeyOfficial? hockeyOfficial =
        ...
        IReadOnlyCollection<Guid> floorballManagerIds =
            (await _floorballTeamManagerRepository.GetAllByPersonIdAsync(personId)
                ?? Array.Empty<Domain.Entities.Floorball.Teams.FloorballTeamManager>())
