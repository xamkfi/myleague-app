...
/// </summary>
public class RestoreNewsArticleHandler : IRequestHandler<RestoreNewsArticleCommand, Result<bool>>
{
    private readonly INewsArticleRepository _newsRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<RestoreNewsArticleHandler> _logger;
    ...
    public RestoreNewsArticleHandler(INewsArticleRepository newsRepository, IUnitOfWork unitOfWork, ILogger<RestoreNewsArticleHandler> logger)
    {
    ...
    public async Task<Result<bool>> Handle(RestoreNewsArticleCommand request, CancellationToken cancellationToken)
    {
        try
        {
