...
/// </summary>
public record UpdateFloorballTournamentPlayoffScheduleCommand(
    Guid CompetitionId,
    IReadOnlyList<FloorballPlayoffScheduleSlotInput> Slots) : IRequest<Result<FloorballTournamentDto>>;
