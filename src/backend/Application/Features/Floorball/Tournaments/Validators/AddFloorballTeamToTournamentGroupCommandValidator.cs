...
/// <summary>
/// Validator for AddFloorballTeamToTournamentGroupCommand
/// </summary>
public class AddTeamToTournamentGroupCommandValidator : AbstractValidator<AddFloorballTeamToTournamentGroupCommand>
{
