...
/// <summary>
/// Validator for UpdateFloorballTournamentCommand
/// </summary>
public class UpdateFloorballTournamentCommandValidator : AbstractValidator<UpdateFloorballTournamentCommand>
{
    public UpdateFloorballTournamentCommandValidator()
    {
