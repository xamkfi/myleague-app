...
/// </summary>
public class StartTournamentGroupStageHandler : IRequestHandler<StartFloorballTournamentGroupStageCommand, Result<FloorballTournamentDto>>
{
    ...
    public async Task<Result<FloorballTournamentDto>> Handle(StartFloorballTournamentGroupStageCommand request, CancellationToken cancellationToken)
    {
        try
        {
