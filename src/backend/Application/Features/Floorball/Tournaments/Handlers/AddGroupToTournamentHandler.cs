...
/// </summary>
public class AddGroupToTournamentHandler : IRequestHandler<AddFloorballGroupToTournamentCommand, Result<FloorballTournamentDto>>
{
    ...
    public async Task<Result<FloorballTournamentDto>> Handle(AddFloorballGroupToTournamentCommand request, CancellationToken cancellationToken)
    {
        try
        {
