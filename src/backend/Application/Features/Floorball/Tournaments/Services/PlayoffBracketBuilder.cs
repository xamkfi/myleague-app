...
public static class PlayoffBracketBuilder
{
    ...
    /// </summary>
    public sealed record Seed(int GroupIndex, int SeedWithinGroup, FloorballTeam Team);

    /// <summary>
    /// One match in the planned bracket. The handler turns these into actual <see cref="FloorballMatch"/>
    /// entities and assigns deterministic Guids before persisting them.
    /// </summary>
    public sealed class PlannedMatch
    {
        public required Guid Id { get; init; }
        public required FloorballPlayoffRound Round { get; init; }
        public required int Order { get; init; }
        public FloorballTeam? HomeTeam { get; set; }
        public FloorballTeam? AwayTeam { get; set; }
        public Guid? NextMatchId { get; set; }
        public FloorballPlayoffSlot? NextMatchSlot { get; set; }
    }
    ...
    public static IReadOnlyList<Seed> BuildSeedList(
        IReadOnlyList<IReadOnlyList<FloorballTeam>> groupRankings,
        int teamsAdvancingPerGroup)
    {
        ...
        for (int rank = 0; rank < teamsAdvancingPerGroup; rank++)
        {
            ...
            {
                IReadOnlyList<FloorballTeam> teams = groupRankings[groupIndex];
                if (rank >= teams.Count)
                {
    ...
    private static IReadOnlyList<PlannedMatch> BuildTwoTeamFinal(IReadOnlyList<Seed> seeds)
    {
        ...
        {
            Id = Guid.NewGuid(),
            Round = FloorballPlayoffRound.Final,
            Order = 0,
    ...
    private static IReadOnlyList<PlannedMatch> BuildFourTeamBracket(IReadOnlyList<Seed> seeds, bool hasThirdPlaceMatch)
    {
        ...
        FloorballTeam sf1Home, sf1Away, sf2Home, sf2Away;
        ...
        PlannedMatch? thirdPlace = hasThirdPlaceMatch
            ...
            {
                Id = Guid.NewGuid(),
                Round = FloorballPlayoffRound.ThirdPlaceMatch,
                Order = 0,
                HomeTeam = sf1Away,
                AwayTeam = sf2Away
            }
        ...
        {
            Id = Guid.NewGuid(),
            Round = FloorballPlayoffRound.SemiFinal,
            Order = 0,
            HomeTeam = sf1Home,
            AwayTeam = sf1Away,
        ...
        PlannedMatch sf2 = new PlannedMatch
        {
            ...
            AwayTeam = sf2Away,
            NextMatchId = final.Id,
            NextMatchSlot = FloorballPlayoffSlot.Away
        };
    ...
    private static IReadOnlyList<PlannedMatch> BuildEightTeamBracket(IReadOnlyList<Seed> seeds, bool hasThirdPlaceMatch)
    {
        ...
        FloorballTeam a1 = seeds[0].Team;
        FloorballTeam b1 = seeds[1].Team;
        FloorballTeam a2 = seeds[2].Team;
        FloorballTeam b2 = seeds[3].Team;
        FloorballTeam a3 = seeds[4].Team;
        FloorballTeam b3 = seeds[5].Team;
        FloorballTeam a4 = seeds[6].Team;
        FloorballTeam b4 = seeds[7].Team;
        ...
        {
            Id = Guid.NewGuid(),
            Round = FloorballPlayoffRound.QuarterFinal,
            Order = 0,
            HomeTeam = a1,
            AwayTeam = b4,
            NextMatchId = sf1.Id,
...
public static class PlayoffBracketReadiness
{
    ...
    /// </summary>
    public static Outcome Evaluate(FloorballTournament tournament, IEnumerable<FloorballMatch> tournamentMatches)
    {
        ArgumentNullException.ThrowIfNull(tournament);
        ArgumentNullException.ThrowIfNull(tournamentMatches);

        FloorballTournamentRules rules = tournament.TournamentRules;
