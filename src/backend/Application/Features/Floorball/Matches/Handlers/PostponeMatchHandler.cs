...
public class PostponeMatchHandler : IRequestHandler<PostponeFloorballMatchCommand, Result<FloorballMatchDto>>
{
    ...
    public async Task<Result<FloorballMatchDto>> Handle(PostponeFloorballMatchCommand request, CancellationToken cancellationToken)
    {
        try
        {
