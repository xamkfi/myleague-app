...
public class UpdateMatchOfficialsHandler : IRequestHandler<UpdateFloorballMatchOfficialsCommand, Result<FloorballMatchDto>>
{
    ...
    public async Task<Result<FloorballMatchDto>> Handle(UpdateFloorballMatchOfficialsCommand request, CancellationToken cancellationToken)
    {
        try
        {
