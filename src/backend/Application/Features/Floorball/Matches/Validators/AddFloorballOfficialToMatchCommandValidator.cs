...
/// <summary>
/// Validates <see cref="AddFloorballOfficialToMatchCommand"/>. Both IDs must be non-empty Guids; match
/// and referee existence are checked by the handler since they require repository access.
/// </summary>
public class AddOfficialToMatchCommandValidator : AbstractValidator<AddFloorballOfficialToMatchCommand>
{
