...
namespace Application.Features.Floorball.Matches.Commands
{
    ...
    /// </summary>
    public class RecordFloorballSaveEventCommand : IRequest<Result<FloorballSaveEventDto>>
    {
        ...
        public RecordFloorballSaveEventCommand(Guid matchId, Guid teamId, Guid goalieId, int periodNumber, int timeInSeconds, bool wasInOvertime, bool wasInShootout)
        {
            MatchId = matchId;
            TeamId = teamId;
            GoalieId = goalieId;
