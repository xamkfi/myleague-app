...
/// </summary>
public class SetFloorballMatchActiveRosterCommand : IRequest<Result<FloorballMatchDto>>
{
    /// <summary>
    ...
    /// </summary>
    public List<FloorballActivePlayerInput> Players { get; set; } = new();
...
/// <summary>
/// Single player + per-match role pair on a <see cref="SetFloorballMatchActiveRosterCommand"/>.
/// </summary>
public class FloorballActivePlayerInput
{
