...
/// <summary>
/// Validator for UpdateFloorballTeamPlayerStatsCommand
/// </summary>
public class UpdateTeamPlayerStatsCommandValidator : AbstractValidator<UpdateFloorballTeamPlayerStatsCommand>
{
