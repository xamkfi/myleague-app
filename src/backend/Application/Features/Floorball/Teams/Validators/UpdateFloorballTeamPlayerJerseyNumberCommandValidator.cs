...
/// <summary>
/// Validator for UpdateFloorballTeamPlayerJerseyNumberCommand
/// </summary>
public class UpdateTeamPlayerJerseyNumberCommandValidator : AbstractValidator<UpdateFloorballTeamPlayerJerseyNumberCommand>
{
