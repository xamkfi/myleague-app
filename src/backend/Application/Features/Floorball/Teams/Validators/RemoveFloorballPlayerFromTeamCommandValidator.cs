...
/// <summary>
/// Validator for RemoveFloorballPlayerFromTeamCommand
/// </summary>
public class RemovePlayerFromTeamCommandValidator : AbstractValidator<RemoveFloorballPlayerFromTeamCommand>
{
