...
/// </summary>
public class AddDivisionToSeasonHandler : IRequestHandler<AddFloorballDivisionToSeasonCommand, Result>
{
    ...
    public async Task<Result> Handle(AddFloorballDivisionToSeasonCommand request, CancellationToken cancellationToken)
    {
        try
        {
