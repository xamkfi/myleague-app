...
public class RemoveTeamFromSeasonHandler : IRequestHandler<RemoveFloorballTeamFromSeasonCommand, Result<FloorballSeasonDto>>
{
    ...
    public async Task<Result<FloorballSeasonDto>> Handle(RemoveFloorballTeamFromSeasonCommand request, CancellationToken cancellationToken)
    {
        try
        {
