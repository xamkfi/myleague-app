...
/// </summary>
public class AddTeamToSeasonHandler : IRequestHandler<AddFloorballTeamToSeasonCommand, Result<FloorballSeasonDto>>
{
    ...
    /// <summary>
    /// Handles the AddFloorballTeamToSeasonCommand request
    /// </summary>
    ...
    public async Task<Result<FloorballSeasonDto>> Handle(AddFloorballTeamToSeasonCommand request, CancellationToken cancellationToken)
    {
        try
        {
            // Get the season
