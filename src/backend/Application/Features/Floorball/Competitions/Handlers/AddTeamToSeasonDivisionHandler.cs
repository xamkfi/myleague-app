...
/// </summary>
public class AddTeamToSeasonDivisionHandler : IRequestHandler<AddFloorballTeamToSeasonDivisionCommand, Result>
{
    ...
    public async Task<Result> Handle(AddFloorballTeamToSeasonDivisionCommand request, CancellationToken cancellationToken)
    {
        try
        {
