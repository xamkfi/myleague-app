...
namespace Domain.Repositories.Common
{
    public interface INewsArticleRepository
    {
        ...
        Task<IEnumerable<NewsArticle>> GetAllAsync(int page, int pageSize, string? category = null, string? sportCategory = null, string? search = null, string? author = null, bool includeArchived = false, IReadOnlyCollection<string>? teamCategories = null, CancellationToken cancellationToken = default);
        ...
        Task<int> GetCountAsync(string? category = null, string? sportCategory = null, string? search = null, string? author = null, bool includeArchived = false, IReadOnlyCollection<string>? teamCategories = null, CancellationToken cancellationToken = default);
