...
### SeasonContentBlock
A rich-text content card (title + HTML body + sort order) attached to a sport and a specific season. Public sport landing pages show the blocks for the selected season year.
