...
/// <summary>
/// Ordered HTML intro block shown on a hockey season's public pages.
/// </summary>
public class HockeySeasonContentBlock : BaseEntity
{
    ...
    private HockeySeasonContentBlock()
    {
    }

    public HockeySeasonContentBlock(Guid seasonId, string title, string contentHtml, int sortOrder)
    {
