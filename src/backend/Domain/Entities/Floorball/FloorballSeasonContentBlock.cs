...
/// <summary>
/// Ordered HTML intro block shown on a floorball season's public pages.
/// </summary>
public class FloorballSeasonContentBlock : BaseEntity
{
    ...
    private FloorballSeasonContentBlock()
    {
    }

    public FloorballSeasonContentBlock(Guid seasonId, string title, string contentHtml, int sortOrder)
    {
