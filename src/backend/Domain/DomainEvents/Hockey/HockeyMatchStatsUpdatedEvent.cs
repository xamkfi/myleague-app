...
/// </summary>
public class HockeyMatchStatsUpdatedEvent : IDomainEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the HockeyMatchStatsUpdatedEvent class
    /// </summary>
    public HockeyMatchStatsUpdatedEvent(
        Guid matchId,
        int periodNumber,
        int timeInSeconds,
        int homeTeamScore,
