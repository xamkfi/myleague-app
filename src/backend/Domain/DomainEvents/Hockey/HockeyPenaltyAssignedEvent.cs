...
/// <summary>
/// Event raised when a penalty is assigned in a Hockey match
/// </summary>
public class HockeyPenaltyAssignedEvent : IDomainEvent
{
    /// <summary>
    ...
    /// </summary>
    public HockeyPenaltyType PenaltyType { get; }
    ...
    /// <summary>
    /// Initializes a new instance of the HockeyPenaltyAssignedEvent class
    /// </summary>
    ...
    public HockeyPenaltyAssignedEvent(
        Guid matchId,
        Guid teamId,
        Guid? playerId,
