...
/// <summary>
/// Event raised when a floorball player's stats are updated
/// </summary>
public class FloorballPlayerStatUpdatedEvent : IDomainEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the FloorballPlayerStatUpdatedEvent class
    /// </summary>
    ...
    public FloorballPlayerStatUpdatedEvent(Guid playerId, int careerGoals, int careerAssists, StatUpdateType updateType)
    {
        Id = Guid.NewGuid();
