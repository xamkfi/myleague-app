...
/// <summary>
/// Event raised when a floorball match is rescheduled
/// </summary>
public class FloorballMatchRescheduledEvent : IDomainEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the FloorballMatchRescheduledEvent class
    /// </summary>
    ...
    public FloorballMatchRescheduledEvent(
        Guid matchId,
