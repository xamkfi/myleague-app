...
/// <summary>
/// Base abstract class for all hockey match events
/// </summary>
public abstract class HockeyMatchEventBase
{
    /// <summary>
    ...
    /// </summary>
    protected HockeyMatchEventBase()
    {
        Id = Guid.NewGuid();
    }

    /// <summary>
    /// Initializes a new instance of the HockeyMatchEventBase class
    /// </summary>
