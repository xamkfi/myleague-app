...
{
    /// <summary>
    /// Request model for getting paginated football teams
    /// </summary>
    public record GetFootballTeamsRequest : PagedRequestBase
    {
        /// <summary>
    ...
    /// <summary>
    /// Request model for getting paginated football teams without roster
    /// </summary>
    ...
    /// <summary>
    /// Request model for creating or updating a football team
    /// </summary>
    ...
    /// </summary>
    public record UpdateFootballTeamPlayerRequest
    {
        /// <summary>
        /// The position of the player
        /// </summary>
        [Required(ErrorMessage = "Position is required")]
        [EnumDataType(typeof(FootballPosition), ErrorMessage = "Invalid position value")]
