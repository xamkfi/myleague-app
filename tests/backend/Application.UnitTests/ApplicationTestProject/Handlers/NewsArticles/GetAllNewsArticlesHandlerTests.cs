...
public class GetAllNewsArticlesHandlerTests
{
    ...
    public async Task Handle_ValidQuery_ReturnsPagedResult()
    {
        ...
        _mockNewsRepository.Setup(x => x.GetAllAsync(1, 3, null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(newsArticles);

        _mockNewsRepository.Setup(x => x.GetCountAsync(null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(10);
        ...
        _mockNewsRepository.Verify(x => x.GetAllAsync(1, 3, null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
        _mockNewsRepository.Verify(x => x.GetCountAsync(null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task Handle_QueryWithFilters_PassesFiltersToRepository()
    {
        ...
        _mockNewsRepository.Setup(x => x.GetAllAsync(2, 3, "General", "Football", "", "Test Author", true, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(newsArticles);

        _mockNewsRepository.Setup(x => x.GetCountAsync("General", "Football", "", "Test Author", true, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(0);
        ...
        _mockNewsRepository.Verify(x => x.GetAllAsync(2, 3, "General", "Football", "", "Test Author", true, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
        _mockNewsRepository.Verify(x => x.GetCountAsync("General", "Football", "", "Test Author", true, It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
    }

    [Fact]
    public async Task Handle_QueryWithTag_PassesTagToRepository()
    {
        GetAllNewsArticlesQuery query = new GetAllNewsArticlesQuery(
            Page: 1,
            PageSize: 3,
        ...
        _mockNewsRepository.Setup(x => x.GetAllAsync(1, 3, null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), "Playoffs", It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<NewsArticle>());

        _mockNewsRepository.Setup(x => x.GetCountAsync(null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), "Playoffs", It.IsAny<CancellationToken>()))
            .ReturnsAsync(0);

        Result<PagedResult<NewsArticleListDto>> result = await _handler.Handle(query, CancellationToken.None);

        result.IsSuccess.Should().BeTrue();
        _mockNewsRepository.Verify(x => x.GetAllAsync(1, 3, null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), "Playoffs", It.IsAny<CancellationToken>()), Times.Once);
        _mockNewsRepository.Verify(x => x.GetCountAsync(null, null, null, null, false, It.IsAny<IReadOnlyCollection<string>>(), "Playoffs", It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task Handle_InvalidPageNumber_ReturnsFailureResult(int invalidPage)
    {
        ...
        _mockNewsRepository.Verify(x => x.GetAllAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task Handle_RepositoryThrowsException_ReturnsFailureResult()
    {
        ...
        _mockNewsRepository.Setup(x => x.GetAllAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
    ...
    public async Task Handle_EmptyResult_ReturnsEmptyPagedResult()
    {
        ...
        _mockNewsRepository.Setup(x => x.GetCountAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<IReadOnlyCollection<string>>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(0);
